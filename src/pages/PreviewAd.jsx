            ...
            <div className="relative w-full mb-4 rounded-lg overflow-hidden">
              ...
              <div className="relative h-56 md:h-[36rem] transition-all duration-500 ease-in-out">
                <div className={`w-full h-full ${getSlideClass()}`}>
                  <img
                    src={`${BASE_URL}/${productDetails?.Photos[activeIndex]}`}
                    className="absolute w-full h-full object-cover"
                    // alt={`${BASE_URL}/${productDetails?.Photos[activeIndex]} - image ${activeIndex + 1}`}
                  />
                </div>
              </div>
          ...
          >
            ...
            <div className="flex gap-2 mb-4 w-full justify-center">
              <Button
                ...
                onPress={() => navigate(`/messages/${productUser?.id}`)}
              >
                Message
              </Button>
              <Button
