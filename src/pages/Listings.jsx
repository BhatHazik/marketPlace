...
const Listings = () => {
  ...
  const categories = [
    {
      ...
      count: 32,
      subcategories: [
        { id: "mobile_phones", name: "Mobile Phones", count: 12 },
        { id: "computers_accessories", name: "Computers & Accessories", count: 8 },
        { id: "tv_video_audio", name: "TV, Video & Audio", count: 6 },
        { id: "cameras_accessories", name: "Cameras & Accessories", count: 4 },
        { id: "games_entertainment", name: "Games & Entertainment", count: 2 },
        { id: "mobile_phones", name: "Mobile Phones", count: 12 },
        { id: "computers_accessories", name: "Computers & Accessories", count: 8 },
        { id: "tv_video_audio", name: "TV, Video & Audio", count: 6 },
        { id: "cameras_accessories", name: "Cameras & Accessories", count: 4 },
    ...
    },
    {
      ...
      count: 25,
      subcategories: [
        { id: "cars", name: "Cars", count: 15 },
        { id: "bikes", name: "Bikes & Motorcycles", count: 5 },
        { id: "commercial_vehicles", name: "Commercial Vehicles", count: 3 },
        { id: "auto_parts", name: "Auto Parts & Accessories", count: 2 }
      ]
    },
    {
      id: "property",
      ...
      count: 18,
      subcategories: [
        { id: "houses", name: "Houses", count: 10 },
        { id: "apartments", name: "Apartments & Flats", count: 5 },
        { id: "commercial", name: "Commercial Property", count: 3 }
      ]
    },
    {
      id: "furniture",
      ...
      count: 15,
      subcategories: [
        { id: "sofa_chairs", name: "Sofa & Chairs", count: 7 },
        { id: "beds_wardrobes", name: "Beds & Wardrobes", count: 5 },
        { id: "office_furniture", name: "Office Furniture", count: 3 }
      ]
    },
    {
      id: "fashion",
      ...
      subcategories: [
        ...
        { id: "footwear", name: "Footwear", count: 5 },
  ...
  // Sample locations
  const locations = [
    { id: "all", name: "All India", count: 110 },
    { id: "delhi", name: "Delhi", count: 24 },
    { id: "mumbai", name: "Mumbai", count: 20 },
    { id: "bangalore", name: "Bangalore", count: 18 },
    { id: "chennai", name: "Chennai", count: 15 },
    { id: "kolkata", name: "Kolkata", count: 13 },
    { id: "hyderabad", name: "Hyderabad", count: 11 },
    { id: "srinagar", name: "Srinagar", count: 9 }
  ];
  ...
  { 
    ...
    name: "Brand", 
    type: "dropdown",
    options: ["Apple", "Samsung", "Sony", "LG", "Honda", "Toyota"]
  },
  { 
    id: "condition", 
    name: "Condition", 
  ...
  },
  {
    ...
    name: "Color",
    type: "dropdown",
    options: ["Black", "White", "Red", "Blue", "Silver", "Grey"]
  },
  {
    id: "storage",
  ...
  },
  {
    ...
    name: "Location",
    type: "dropdown",
    options: ["Delhi", "Mumbai", "Bangalore", "Chennai", "Hyderabad", "Pune"]
  },
  {
    id: "transmission",
    name: "Transmission",
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        <DrawerContent>
          ...
          <DrawerBody>
                  ...
                  >
                    <ScrollShadow className="max-h-40 overflow-y-auto category-scrollbar " >
                      ...
                      <RadioGroup 
                        ...
                        onValueChange={(value) => handleSubcategorySelect(category.id, value)}
                      ...
                      >
                        {category.subcategories.map((subcategory) => (
                          ...
                          >
                            {subcategory.name} <span className="text-gray-500 text-xs">({subcategory.count})</span>
                          </Radio>
                        ))}
                      </RadioGroup>
                    </ScrollShadow>
            ...
            {/* Price Range Slider */}
            <div className="mb-6">
              <h3 className="font-semibold text-lg mb-3 text-gray-800">Price Range</h3>
              <div className="px-2">
                <Slider
                  label="Price"
                  step={5000}
            ...
            <div className="mb-0">
              ...
              >
                <AccordionItem
                  ...
                  startContent={<FontAwesomeIcon icon={faLocationDot} className="text-gray-500" />}
                >
                  ...
                  >
                    {locations.map((location) => (
                      <Radio key={location.id} value={location.id}>
                        {location.name} <span className="text-gray-500 text-xs">({location.count})</span>
                      </Radio>
                    ))}
                  </RadioGroup>
                </ScrollShadow>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className={`w-full md:w-1/4 bg-white rounded-lg h-max shadow p-4 hidden md:block transition-all duration-300 ease-in-out ${isFilterVisible ? 'md:opacity-100 md:max-w-full' : 'md:opacity-0 md:max-w-0 md:overflow-hidden md:p-0'}`}>
            {/* Categories Accordion */}
            <div className="mb-6">
              <h3 className="font-semibold text-lg mb-3 text-gray-800">Categories</h3>
              <Accordion
          ...
          <div className={`w-full ${isFilterVisible ? 'md:w-3/4' : 'md:w-full'} transition-all duration-300 ease-in-out`}>
            {/* Search Bar and Filter Section */}
            <div className="mb-6 bg-white rounded-lg shadow p-4">
              <div className={`w-full ${isTopFilterVisible ? 'border-b mb-4 border-gray-200 pb-4' : 'mb-0 pb-0'}`}>
                {/* Mobile Layout - Stack */}
                ...
                <div className="hidden md:flex items-center">
                  ...
                  <div className="ml-4 w-[30%]">
                    <Checkbox
                      ...
                      onValueChange={setOnlyInCategory}
                      color="success"
                      className="data-[selected=true]:text-white text-nowrap flex justify-center bg-[#CEE9DC] rounded-full py-3 pl-3"
                    >
                      Only in {getSelectedCategoryName()}
                    </Checkbox>
                  </div>
              ...
              <div className={`w-full overflow-hidden transition-all duration-300 ease-in-out ${isTopFilterVisible ? 'max-h-[2000px] opacity-100 mt-4' : 'max-h-0 opacity-0 mt-0'}`}>
